"""
🤖 BOT TELEGRAM ANIME - AVEC JIKAN API ET .ENV
==============================================
Utilise le fichier .env pour les tokens!
...
if __name__ == "__main__":
    ...
    try:
        ...
        print("2. Va sur @BotFather sur Telegram")
        print("3. Crée un bot avec /newbot")
        print("4. Copie le token et mets-le dans .env:")
